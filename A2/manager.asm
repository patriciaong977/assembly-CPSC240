...
section .data                   ;Place initialized data here
    ...
    thisProgram db "This program will sum your array of integers.", 10, 0
    ...
    return db "The sum will now be returned to the main function. ", 10, 0
...
;------------------------------------------------------------------------------------------------------------
    ...
    mov qword rax, 0
    mov rdi, stringFormat       ;"%s"
    mov rsi, return             ;"The sum will now be returned to the main function. "
    call printf                 ;Call printf function
